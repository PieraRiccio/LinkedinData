...
```{r}
data_white_total <- dplyr::select(df, ethnicity, tenure_len, m_urn) %>% filter (ethnicity == "White")
...
data_black_total <- dplyr::select(df, ethnicity, tenure_len, m_urn) %>% filter (ethnicity == "Black")
...
data_asian_total <- dplyr::select(df, ethnicity, tenure_len, m_urn) %>% filter (ethnicity == "Asian")
