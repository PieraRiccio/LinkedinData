...
Nell'analisi degli individui appartenenti al dataset che risultano essere stati assunti (14747), si deduce che una possibile variabile discriminatoria sia la lunghezza dell'assunzione. Seguendo l'intuizione per la quale un'assunzione di breve durata (circa un anno) implica che possano essere insorti problemi sul posto di lavoro e che, al contrario, un'assunzione di lunga durata sia indice di uno stato lavorativo soddisfacente, il criterio di sufficienza in questo dataset viene verificato analizzando le distribuzioni delle lunghezze degli incarichi ottenuti tra categorie diverse identificate nel dataset. In particolare, le analisi sono state condotte su possibili discriminazioni di genere, di razza e di bellezza.
