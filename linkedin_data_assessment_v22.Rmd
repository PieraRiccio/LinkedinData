...
# *CONCLUSIONE*
Dallo studio effettuato si può facilmente dedurre che il dataset non presenti in alcun modo evidenti disparità per quanto riguarda le etnie e la bellezza. Al contrario, specialmente nell'analisi manuale, è stata riscontrata qualche leggera discriminazione in merito al sesso dei lavoratori presi in considerazione. Sebbene questo risultato possa essere del tutto involontario e non nelle intenzioni delle aziende analizzate, è comunque importantissimo riconoscerlo e tenerne conto qualora si volesse utilizzare questo dataset per addestrare un algoritmo decisionale per l'assunzione o la promozione dei lavoratori. Anche se in maniera lieve, un tale algoritmo potrebbe in qualche modo operare a svantaggio delle donne. Quest'ultime, infatti, oltre ad essere in netta minoranza rispetto ai colleghi uomini, sono anche generalmente assunte più difficilmente (la loro percentuale cresce tra i non assunti rispetto a quella tra gli assunti) e per minor tempo.