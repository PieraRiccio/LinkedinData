...
mean_males_total <- mean(data_males_total[["tenure_len"]])/40
st_dev_males_total <- sd(data_males_total[["tenure_len"]])/40
data_females_total <- dplyr::select(df, gender, tenure_len, m_urn) %>% filter (gender == "Female")
mean_females_total <- mean(data_females_total[["tenure_len"]])/40
st_dev_females_total <- sd(data_females_total[["tenure_len"]])/40
...
mean_males_low <- mean(data_males_low[["tenure_len"]])/40
st_dev_males_low <- sd(data_males_low[["tenure_len"]])/40
data_females_low <- dplyr::select(df, gender, tenure_len, m_urn) %>% filter (gender == "Female") %>% filter (tenure_len<3000)
mean_females_low <- mean(data_females_low[["tenure_len"]])/40
st_dev_females_low <- sd(data_females_low[["tenure_len"]])/40
